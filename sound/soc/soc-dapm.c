...
#ifdef CONFIG_KYOCERA_MSND
bool snd_soc_ic_recoder_active_flag = false;
bool snd_soc_get_ic_recoder_active( void )
{
	return snd_soc_ic_recoder_active_flag;
}
EXPORT_SYMBOL_GPL(snd_soc_get_ic_recoder_active);
			 ...
			 struct list_head *list, int event, bool power_up)
{
	...
	list_for_each_entry_safe(w, n, list, power_list) {
		...
		#ifdef CONFIG_KYOCERA_MSND
		if ( !strcmp(w->name, "TERT_MI2S_TX") ) {
			snd_soc_ic_recoder_active_flag = power_up;
			dev_dbg(w->dapm->dev, "dapm: ic recorder active : %d\n",snd_soc_ic_recoder_active_flag);
		}
		#endif /* CONFIG_KYOCERA_MSND */
