...
int WCD9XXX_SYSTEM_RESUME_TIMEOUT_MS = 30000;
#else
...
#ifdef CONFIG_KYOCERA_MSND
void wcd9xxx_spmi_set_SYSTEM_RESUME_TIMEOUT( unsigned int in_time )
{
	pr_err( "%s timeout=%d -> %d", __func__, WCD9XXX_SYSTEM_RESUME_TIMEOUT_MS, in_time );
	WCD9XXX_SYSTEM_RESUME_TIMEOUT_MS = in_time;
}
#endif
