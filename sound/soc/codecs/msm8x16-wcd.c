 ...
 * (C) 2015-2018 KYOCERA Corporation
 */
...
#include <../../../drivers/power/oem-chg_control.h>
...
#ifdef CONFIG_KYOCERA_MSND
static int msm8x16_wcd_charge_speaker_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
#ifdef CONFIG_KYOCERA_MSND
static int msm8x16_wcd_charge_speaker_put(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	bool enable;
	...
	oem_current_limit_enable(enable);
...
#ifdef CONFIG_KYOCERA_MSND
static const char * const msm8x16_wcd_charge_speaker_text[] = {
		"DISABLE", "ENABLE"};
static const struct soc_enum msm8x16_wcd_charge_speaker_enum[] = {
		SOC_ENUM_SINGLE_EXT(2, msm8x16_wcd_charge_speaker_text),
};
#endif /* CONFIG_KYOCERA_MSND */
...
#ifdef CONFIG_KYOCERA_MSND
	SOC_ENUM_EXT("Charge Speaker", msm8x16_wcd_charge_speaker_enum[0],
		msm8x16_wcd_charge_speaker_get, msm8x16_wcd_charge_speaker_put),
#endif /* CONFIG_KYOCERA_MSND */
...
static const struct msm8x16_wcd_reg_mask_val msm8x16_wcd_reg_defaults_2_0[] = {
	...
	MSM8X16_WCD_REG_VAL(MSM8X16_WCD_A_ANALOG_SPKR_DAC_CTL, 0x03),
#ifdef CONFIG_KYOCERA_MSND
	MSM8X16_WCD_REG_VAL(MSM8X16_WCD_A_ANALOG_SPKR_OCP_CTL, 0xA1),
#else
	MSM8X16_WCD_REG_VAL(MSM8X16_WCD_A_ANALOG_SPKR_OCP_CTL, 0xE1),
#endif
};
...
#ifdef CONFIG_KYOCERA_MSND
	wcd9xxx_spmi_disable_irq(MSM8X16_WCD_IRQ_MBHC_INSREM_DET);
	wcd9xxx_spmi_disable_irq(MSM8X16_WCD_IRQ_MBHC_INSREM_DET1);
#endif
...
#ifdef CONFIG_KYOCERA_MSND
extern int kaudio_wcd_init(struct snd_soc_codec *codec);
#endif
