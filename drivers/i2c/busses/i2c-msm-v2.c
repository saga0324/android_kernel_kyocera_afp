...
#define GPIO_I2C_CAM_OLED_SDA  29
#define GPIO_I2C_CAM_OLED_SCL  30
#define GPIO_I2C_SMB_SDA       14
#define GPIO_I2C_SMB_SCL       15
#define GPIO_I2C_PRIM_SDA      18
#define GPIO_I2C_PRIM_SCL      19
#define GPIO_I2C_TP_SDA        10
#define GPIO_I2C_TP_SCL        11
...
#define MSM_8909_BLSP1_QUP6_I2C_BUS_ID   6
...
i2c_msm_compulsory_reset(struct i2c_adapter *adap, bool init_flg)
{
	...
	if(((adap->nr) == MSM_8909_BLSP1_QUP4_I2C_BUS_ID) ||
	   ((adap->nr) == MSM_8909_BLSP1_QUP5_I2C_BUS_ID)){
...
i2c_msm_pinctrl_set_default(struct i2c_adapter *adap)
{
	...
	if((adap->nr) == MSM_8909_BLSP1_QUP6_I2C_BUS_ID) {
...
static void i2c_msm_pm_suspend(struct device *dev)
{
	...
	if (ctrl->adapter.nr != MSM_8909_BLSP1_QUP6_I2C_BUS_ID)
