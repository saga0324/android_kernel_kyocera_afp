...
#define MSM_8909_BLSP1_QUP1_REG_ADDRESS 0x78b5000
...
static int init_resources(struct platform_device *pdev)
{
	...
	if(dd->mem_phys_addr == MSM_8909_BLSP1_QUP1_REG_ADDRESS)
		writel_relaxed(SPI_IO_C_NO_TRI_STATE | SPI_IO_C_CS_N_POLARITY_1_3, dd->base + SPI_IO_CONTROL);
	else
