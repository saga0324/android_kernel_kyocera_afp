...
#define M12MO_MON_SIZE_1_03M_WIDTH  (1392)
#define M12MO_MON_SIZE_1_03M_HEIGHT (778)
...
enum m12mo_i2c_byte_monitor_still_b {
    ...
    M12MO_I2C_CAT_MON_REVERSE                   = 0x05,
    M12MO_I2C_CAT_MON_MIRROR                    = 0x06,
...
#define M12MO_I2C_VAL_MON_SIZE_1_03M            (0x5A)
...
/* 02: Monitor&Still parameter B - 0x05: REVERSE */
#define M12MO_I2C_VAL_REVERSE_OFF               (0x00)
#define M12MO_I2C_VAL_REVERSE_ON                (0x01)

/* 02: Monitor&Still parameter B - 0x06: MIRROR  */
#define M12MO_I2C_VAL_MIRROR_OFF               (0x00)
#define M12MO_I2C_VAL_MIRROR_ON                (0x01)
