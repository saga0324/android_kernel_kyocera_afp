...
void mdss_dsi_host_init(struct mdss_panel_data *pdata)
{
	...
	kdisp_debug_dump_dsi_clkout_timing_reg(ctrl_pdata->ctrl_base);
...
static void mdss_dsi_mode_setup(struct mdss_panel_data *pdata)
{
	...
	if (pdata->panel_info.type == MIPI_VIDEO_PANEL) {
		...
		kdisp_debug_dump_dsi_video_reg(ctrl_pdata->ctrl_base);
					...
					struct dsi_buf *tp)
{
	...
	kdisp_debug_log_output_dsi_cmd_tx(bp, len);
