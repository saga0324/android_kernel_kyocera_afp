...
int mdss_dsi_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	...
	if (enable) {
		...
		kdisp_mipiic_reset_seq(&ctrl_pdata->kc_ctrl_data, 1);
		...
		kdisp_mipiic_reset_seq(&ctrl_pdata->kc_ctrl_data, 0);
	}
...
static int mdss_dsi_panel_on(struct mdss_panel_data *pdata)
{
	...
	kdisp_mipiic_dsi_panel_on_post(pdata);
