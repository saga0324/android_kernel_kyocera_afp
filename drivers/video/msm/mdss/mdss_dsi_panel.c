...
int mdss_dsi_panel_off_post(struct mdss_panel_data *pdata)
{
	struct mdss_dsi_ctrl_pdata *ctrl = NULL;
	...
	if (ctrl->off_post_cmds.cmd_cnt)
		mdss_dsi_panel_cmds_send(ctrl, &ctrl->off_post_cmds);
			...
			struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->off_post_cmds,
		"qcom,mdss-dsi-off-post-command", "qcom,mdss-dsi-off-post-command-state");
