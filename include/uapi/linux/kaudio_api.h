...
#define KLOG_FILE_NO_MAX 28

enum {
	KAUDIO_IOCTL_GET_JACK_STATE = 1,
	KAUDIO_IOCTL_SET_SYSTEM_RESUME_TIMEOUT,
	KAUDIO_IOCTL_SET_REG_VAL,
	KAUDIO_IOCTL_GET_REG_VAL,
	KAUDIO_IOCTL_SET_LOG_STATE,
};
...
typedef union {
	...
	kaudio_reg_val_t				reg_val;
	kaudio_log_state_t				log_state;
} kaudio_ioctl_t ;
