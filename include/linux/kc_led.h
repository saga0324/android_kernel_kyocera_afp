...
extern int32_t cat4004b_light_led_disp_set_panel(e_light_main_wled_disp disp_status, e_light_lcd_panel panel_class);
extern int32_t cat4004b_light_led_disp_power_set(e_light_main_wled_disp disp_status);

extern int32_t lv5216_2_light_led_disp_set_panel(e_light_main_wled_disp disp_status, e_light_lcd_panel panel_class);
extern int32_t lv5216_2_light_led_disp_power_set(e_light_main_wled_disp disp_status);
